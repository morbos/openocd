...
enum trace_config_type_v8m {
	TRACE_CONFIG_TYPE_DISABLED_V8M,	/**< tracing is disabled */
	TRACE_CONFIG_TYPE_EXTERNAL_V8M,	/**< trace output is captured externally */
	TRACE_CONFIG_TYPE_INTERNAL_V8M	/**< trace output is handled by OpenOCD adapter driver */
};

enum tpiu_pin_protocol_v8m {
	TPIU_PIN_PROTOCOL_SYNC_V8M,			/**< synchronous trace output */
	TPIU_PIN_PROTOCOL_ASYNC_MANCHESTER_V8M,	/**< asynchronous output with Manchester coding */
	TPIU_PIN_PROTOCOL_ASYNC_UART_V8M	/**< asynchronous output with NRZ coding */
};
...
struct armv8m_trace_config {
	...
	enum tpiu_pin_protocol_v8m pin_protocol;
